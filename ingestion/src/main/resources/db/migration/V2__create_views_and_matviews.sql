-- =============================================================================
-- V2 - Camada de Transformação: Materialized Views e Views Regulares
-- =============================================================================

-- 1. Materialized View Municipal Base
...
SELECT
    ...
    p.populacao::bigint AS populacao,
...
-- 2. View Regular Municipal
CREATE OR REPLACE VIEW vw_indicadores_municipio AS
SELECT
    municipio_ibge, ano_mes, ano_pix, municipio, estado, regiao, sigla_regiao,
    penetracao_pf, tx_per_capita_pf, vl_per_capita_pf, ticket_medio_pf, razao_pj_pf,
    qt_pes_pagador_pf, qt_pagador_pf, qt_recebedor_pf, qt_pagador_pj, vl_pagador_pf, vl_recebedor_pf,
    populacao, ano_populacao, pib_per_capita, ano_pib, taxa_urbanizacao, ano_urbanizacao,
    idhm, idhm_educacao, idhm_renda, ano_idhm
FROM mv_indicadores_municipio;

-- 3. Materialized View Regional (Agregações Ponderadas)
...
CREATE INDEX idx_mv_evolucao_regional_ano_mes ON mv_evolucao_regional (ano_mes);

-- 4. View Regular Regional
CREATE OR REPLACE VIEW vw_evolucao_regional AS
SELECT
    ano_mes, ano_pix, regiao, sigla_regiao, penetracao_media,
    ticket_medio, valor_per_capita, razao_pj_pf_media, populacao_total
